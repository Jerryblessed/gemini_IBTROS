...
conversation_after_start = "Hello!\n" \
                           "Welcome to IBTROS!\n" \
                           "Here you can order 🚘 <b>Vehicles</b> and get rides to your destination.\n" \
...
conversation_open_admin_menu = "You are a 💼 <b>Admin</b> of this shuttle\n" \
...
conversation_cart_actions = "<i>order for seat(s) by scrolling up and pressing the book button below" \
                            " the shuttle you want to book. When you're done, go back to this message and" \
...
ask_destination = "Input your destination or say it in natural language processing ?\n" \
...
error_no_worker_for_chat = "💬 It looks like your conversation with us was paused.\n" \
                           "To continue, simply type /start to resume where we left off. We're here to help you get back on track!"
